		...
		<section className='project-content prismlayout'>
			<div className='cover'>
				<ProjectNav
					...
					technologies={['Reacjs, ContextAPI, Stripejs,']}
					githubLink='https://github.com/Noel-Garces08/amazon-clone'
					liveLink='https://clone-4fa6d.web.app/'
				/>
			...
			<div className='bottom-navigation'>
				...
				<Link to='/amazon-clone' className='link link-active'>Amazon Clone</Link>
